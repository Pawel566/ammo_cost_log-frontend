    ...
    <div>
      <div style={{ marginBottom: '2rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
          <h2 style={{ margin: 0 }}>Sesje celnościowe</h2>
          <button 
        ...
        {showForm && guns.length > 0 && ammo.length > 0 && (
          <div className="card" style={{ marginBottom: '1.5rem' }}>
            <h3 style={{ marginBottom: '1rem' }}>Dodaj sesję celnościową</h3>
        ...
        <div className="card">
          <h3 style={{ marginBottom: '1rem' }}>Historia sesji celnościowych</h3>
          ...
          {filteredSessions.length === 0 ? (
            <p className="text-center" style={{ color: '#888', padding: '2rem' }}>
              Brak zarejestrowanych sesji celnościowych
            </p>
          ) : (
                ...
                <tbody>
                  {filteredSessions.map((session) => (
                    <tr key={session.id}>
                      ...
                      <td style={{ 
                        fontWeight: 'bold', 
                        color: session.accuracy_percent >= 80 ? '#28a745' : session.accuracy_percent >= 60 ? '#ffc107' : '#dc3545' 
                      }}>
